...
return [
    ...
    */
    ...
    'custom_cms_name' => env('STATAMIC_CUSTOM_CMS_NAME', 'Macework'),
    ...
    'custom_favicon_url' => env('STATAMIC_CUSTOM_FAVICON_URL', '/macework-cp/macework-favicon.svg'),

    'custom_css_url' => env('STATAMIC_CUSTOM_CSS_URL', '/macework-cp/macework-cp.css'),
